window.invitationConfig = {
  ...
  text: {
    ...
    storyTitle: "Put your story!",
    storyBody:
      "Tell how your story started...",
    ...
    songTitle: "A perfect song for the celebration",
    songDescription:
  ...
  elementVisibility: {
    ...
    heroCityLabel: true,
    heroCityValue: true,
    countdownEyebrow: true,
    countdownTitle: false,
    countdownDaysCard: true,
    countdownDaysLabel: true,
    countdownHoursCard: true,
    countdownHoursLabel: true,
    countdownMinutesCard: true,
    countdownMinutesLabel: true,
    countdownSecondsCard: true,
    countdownSecondsLabel: true,
    storyEyebrow: true,
    storyTitle: true,
    storyBody: false,
    galleryEyebrow: true,
    ...
    locationCardText: true,
    mapLink: true,
    dressCodeCard: false,
    dressCodeCardTitle: true,
    dressCodeCardText: true,
    notesCard: true,
    notesCardTitle: true,
    notesCardText: true,
    musicWidget: true,
    ...
    songCreditBlock: false,
    songCreditLabel: false,
    songCreditValue: false,
    songStatusBlock: false,
    songStatusLabel: false,
    songStatusValue: false,
    uploadEyebrow: true,
    uploadTitle: true,
    ...
    rsvpEyebrow: true,
    rsvpTitle: true,
    rsvpDescription: true,
    rsvpContacts: false,
    rsvpForm: true,
    rsvpNameField: true,
    rsvpAttendanceField: true,
    rsvpMessageField: true,
    rsvpSubmit: true,
    guestbookEyebrow: true,
    guestbookTitle: true,
    guestbookText: true,
    paletteEyebrow: true,
    paletteTitle: true,
    dressPaletteSwatches: true,
    faqEyebrow: true,
    faqTitle: true,
    faqList: true,
    footer: true,
